...
namespace TMHelper.Activities
{
    ...
    public class NewCorporationActivity : Activity
    {
        ...
        public event EventHandler<NewCorporationEventArgs> OnCorporationCreated; 

        protected override void OnCreate(Bundle savedInstanceState)
        {
            base.OnCreate(savedInstanceState);
            SetContentView(Resource.Layout.newCorporation_activity);
        ...
        private void SaveButton_Click(object sender, EventArgs e)
        {
            ...
            if (gameRepo.IsExistingId(gameId))
            {
                if (!gameRepo.IsExistingPlayer(gameId, playerName))
                {
                    ...
                    OnCorporationCreated?.Invoke(this, new NewCorporationEventArgs());
                    Finish();
                }
                else
                {
    ...
    public class NewCorporationEventArgs : EventArgs
    {
